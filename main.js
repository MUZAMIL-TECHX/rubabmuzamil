        ...
        switch (true) {
          ...
          case userMessage.startsWith('.apifetch'):
            ...
            case userMessage.startsWith('.fb') || userMessage.startsWith('.facebook'):
                ...
                break;
            case userMessage.startsWith('.music') || userMessage === '.play' || userMessage.startsWith('.play '):
                await playCommand(sock, chatId, message);
                break;
            case userMessage.startsWith('.spotify'):
                await spotifyCommand(sock, chatId, message);
                break;
            case userMessage === '.song' || userMessage.startsWith('.song ') || userMessage.startsWith('.mp3') || userMessage.startsWith('.ytmp3'):
