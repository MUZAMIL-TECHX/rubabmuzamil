...
function loadUserGroupData(sock = null) {
    try {
        if (sock) return readSessionJson(sock, 'userGroupData.json', {
...
function saveUserGroupData(data, sock = null) {
    try {
        if (sock) {
...
async function setAntilink(groupId, type, action, sock = null) {
    try {
...
async function getAntilink(groupId, type, sock = null) {
    try {
        const data = loadUserGroupData(sock);
...
async function removeAntilink(groupId, type, sock = null) {
    try {
        const data = loadUserGroupData(sock);
...
async function setAntitag(groupId, type, action, sock = null) {
    try {
        const data = loadUserGroupData(sock);
...
async function getAntitag(groupId, type, sock = null) {
    try {
        const data = loadUserGroupData(sock);
...
async function removeAntitag(groupId, type, sock = null) {
    try {
        const data = loadUserGroupData(sock);
...
async function incrementWarningCount(groupId, userId, sock = null) {
    try {
        const data = loadUserGroupData(sock);
...
async function resetWarningCount(groupId, userId, sock = null) {
    try {
        const data = loadUserGroupData(sock);
...
async function isSudo(userId, sock = null) {
    try {
        const data = loadUserGroupData(sock);
...
// Manage sudo users
async function addSudo(userJid, sock = null) {
    try {
        const data = loadUserGroupData(sock);
...
async function removeSudo(userJid, sock = null) {
    try {
        const data = loadUserGroupData(sock);
        if (!data.sudo) data.sudo = [];
...
async function getSudoList(sock = null) {
    try {
        const data = loadUserGroupData(sock);
...
async function setAntiBadword(groupId, type, action, sock = null) {
    try {
        const data = loadUserGroupData(sock);
...
async function getAntiBadword(groupId, type, sock = null) {
    try {
        const data = loadUserGroupData(sock);
...
async function removeAntiBadword(groupId, type, sock = null) {
    try {
        const data = loadUserGroupData(sock);
        if (data.antibadword && data.antibadword[groupId]) {
