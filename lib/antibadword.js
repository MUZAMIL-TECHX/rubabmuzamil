...
async function handleBadwordDetection(sock, chatId, message, userMessage, senderId) {
    ...
    // Use the local list immediately when it already caught a match. For other
    // messages the configured Llama API checks context and less obvious wording.
    const aiContainsBadWord = localContainsBadWord
        ? true
        : await detectBadwordWithAI(userMessage);
