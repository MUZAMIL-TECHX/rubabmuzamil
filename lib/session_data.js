...
const DEFAULT_SESSION_SETTINGS = {
    botName: '𝑅𝑼𝛣𝜦𝛣 × 𝑀𝑼𝑍𝜦𝑀𝜤𝐋',
    ownerName: appSettings.botOwner || '𝑅𝑼𝛣𝜦𝛣 × 𝑀𝑼𝑍𝜦𝑀𝜤𝐋',
    ownerNumber: appSettings.ownerNumber || '923433740855',
    description: appSettings.description || '𝗣𝗼𝘄𝗲𝗿𝗲𝗱 𝗕𝘆 𝑅𝑼𝛣𝜦𝛣 × 𝑀𝑼𝑍𝜦𝑀𝜤𝐋.',
    botDp: 'https://n.uguu.se/vXyuLjNl.jpg'
};
